            ...
            <div class="card-body">
              ...
              <div class="form-group row {{$errors->has('name') ? ' has-error':''}}">
                ...
                <div class="col-sm-7">
                  ...
                  <input type="text" class="form-control custom_form_control" name="name" value="{{$data->expcate_name}}">
                  @if ($errors->has('name'))
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control custom_form_control" name="remarks" value="{{$data->expcate_remarks}}">
                </div>
              </div>
            </div>
