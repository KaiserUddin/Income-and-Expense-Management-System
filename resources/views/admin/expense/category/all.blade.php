          ...
          <div class="card-header">
              <div class="row">
                  <div class="col-md-8 card_header_title">
                      All Expense Category Information
                  </div>
                  <div class="col-md-4 card_btn_part">
                      <a href="{{url('admin/expense/category/add')}}" class="btn btn-sm btn-dark">Add Expense Category</a>
                  </div>
              </div>
          </div>
          <div class="card-body">
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <a href="{{url('admin/expense/category/view/'.$data->expcate_slug)}}"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                      <a href="{{url('admin/expense/category/edit/'.$data->expcate_slug)}}"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
                      <a href="#" id="softDelete" data-toggle="modal" data-target="#softDeleteModal" data-id="{{$data->expcate_id}}"><i class="fa fa-trash fa-lg delete_icon"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
