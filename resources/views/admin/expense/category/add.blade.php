...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="{{url('admin/expense/category/submit')}}">
          @csrf
          <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8 card_header_title">
                        Add Expense Category Information
                    </div>
            ...
            <div class="card-body">
              @if(Session::has('success'))
                <script>
                  swal({ title: "Success!", text: "expense category created successfully!", icon: "success", timer: 5000});
                </script>
              @endif
