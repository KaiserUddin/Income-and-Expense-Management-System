          ...
          <div class="card-header">
              <div class="row">
                  <div class="col-md-8 card_header_title">
                      All Expense Category Trash List
                  </div>
            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <a href="#" id="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->expcate_id}}"><i class="fa fa-recycle fa-lg edit_icon"></i></a>
                      <a href="#" id="delete" data-toggle="modal" data-target="#deleteModal" data-id="{{$data->expcate_id}}"><i class="fa fa-trash fa-lg delete_icon"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('admin/expense/category/restore')}}">
      @csrf
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('admin/expense/category/delete')}}">
      @csrf
      <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-gg-circle"></i> Confirm Message</h5>
